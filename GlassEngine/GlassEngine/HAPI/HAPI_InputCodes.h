...
// These are now replaced with more sensible names above but kept here for backward compatability
#define HK_MENU           0x12	// Now use HK_LALT
#define HK_LMENU          0xA4	// Now use HK_LALT
#define HK_RMENU          0xA5	// Now use HK_RALT
...
// Gamepad deadzones (these are for XBox 360 controller - other controllers may differ)
